						...
						<Col sm={6}>
							<Form onSubmit={this.handleSubmit}>
								<Form.Group>
									...
									<Form.Control type="text" name="EmployeeId" id="EmployeeId" disabled defaultValue={this.props.empid} required />
								</Form.Group>

								<Form.Group controlId="EmployeeName">
									<Form.Label>Employee Name</Form.Label>
									<Form.Control type="text" defaultValue={this.props.empname} required />
								</Form.Group>
								...
								<Form.Group>
									...
									<Form.Control type="date" name="DateOfJoining" id="DateOfJoining" defaultValue={this.props.empdoj} required />
								</Form.Group>

								<Form.Group>
									<ButtonGroup aria-label="modal-buttons">
										<Button variant="outline-danger" onClick={this.props.onHide}>Cancel</Button>
										<Button variant="dark" type="submit">Update Employee</Button>
									</ButtonGroup>
								</Form.Group>
							</Form>
						</Col>
